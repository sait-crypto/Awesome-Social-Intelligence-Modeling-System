(() => {
  ...
  const messages = {
    en: {
      ...
      "form.paperFileHint": "recommended · choose, drop, or paste PDF · 50 MiB",
      "form.paperFileDropLabel": "Choose, drop, or paste a paper PDF",
      "form.choosePaperFile": "Choose",
      "form.choosePaperFileLabel": "Choose a paper PDF",
      "form.pastePaperFile": "Paste",
      "form.pastePaperFileLabel": "Paste a paper PDF from the clipboard",
      ...
      "upload.popupBlocked": "Allow pop-ups for this site so the completed upload can open the GitHub issue.",
      "upload.waitingTitle": "Uploading submission files…",
      "upload.waitingPage": "The selected files are being uploaded securely. This tab will continue to the GitHub issue when they are ready.",
      "upload.progress": "Uploading {completed} / {total}: {name}",
      "upload.complete": "All {total} selected file(s) were uploaded. Opening GitHub…",
      "upload.failed": "The files were not submitted: {message} Nothing has been sent to the processing pipeline.",
      "upload.manualFallback": "Direct upload is not configured yet; GitHub will ask you to attach the selected files manually.",
      ...
      "paperFile.clipboardEmpty": "No PDF is currently in the clipboard.",
    ...
    zh: {
      ...
      "form.paperFile": "论文原文",
      "form.paperFileHint": "推荐 · 选择、拖入或粘贴 PDF · 50 MiB",
      "form.paperFileDropLabel": "选择、拖入或粘贴论文 PDF",
      "form.choosePaperFile": "选择",
      "form.choosePaperFileLabel": "选择论文 PDF",
      "form.pastePaperFile": "粘贴",
      "form.pastePaperFileLabel": "从剪贴板粘贴论文 PDF",
      ...
      "upload.popupBlocked": "请允许本网站打开弹窗，以便文件上传完成后进入 GitHub Issue。",
      "upload.waitingTitle": "正在上传提交文件…",
      "upload.waitingPage": "正在安全上传所选文件。全部就绪后，本页会自动进入 GitHub Issue。",
      "upload.progress": "正在上传 {completed} / {total}：{name}",
      "upload.complete": "已上传全部 {total} 个文件，正在打开 GitHub…",
      "upload.failed": "文件未提交：{message} 自动处理管线尚未收到本次文件。",
      "upload.manualFallback": "直接上传服务尚未配置；进入 GitHub 后仍需手动添加所选文件。",
      ...
      "paperFile.clipboardEmpty": "剪贴板中没有 PDF 文件。",
