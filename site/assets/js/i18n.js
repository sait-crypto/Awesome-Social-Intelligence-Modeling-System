(() => {
  ...
  const messages = {
    en: {
      ...
      "form.pipelineHint": "optional · choose, drop, or paste · 4 × 10 MiB",
      ...
      "form.paperFileHint": "optional · choose or drop PDF · 50 MiB",
      ...
      "zotero.categoryUnrecognized": "Category tags were not recognized; maintainers will assign the taxonomy during review.",
      ...
      "submission.clearConfirm": "Clear all entered or imported metadata and selected files? This cannot be undone.",
    ...
    zh: {
      ...
      "definition.title": "什么是 SIM？",
      "definition.context": "AI 研究社会问题已有多年，但这一领域仍然碎片化。社会智能相关研究分布在情感分析、虚假信息检测、用户建模、内容生成、多智能体系统和社会模拟等不同方向。由于这些研究使用不同的任务名称与关键词，人们很难看清它们之间的联系，也难以形成对整个领域的清晰认识。",
      "definition.lead": "我们的社会智能建模（SIM）框架将这些碎片整合起来。通过组织横跨 20 余项任务的近 1,000 篇论文，我们展示 AI 如何建模社会内容、人、关系和社会演化。SIM 将该领域组织为四个相互连接的层级：感知、理解、生成和模拟，从而统一呈现 AI 如何参与社会系统。",
      ...
      "community.title": "加入交流",
      "community.lead": "参与综述讨论，或查看当前微信群加入方式。",
      "community.discussionLabel": "GitHub Discussions",
      "community.discussionTitle": "参与综述讨论",
      "community.discussionDesc": "向 AI4SS 社区提问、推荐论文并讨论分类体系。",
      "community.discussionButton": "打开讨论区",
      "community.wechatLabel": "微信群",
      "community.wechatTitle": "加入 AI4SS 综述群",
      "community.wechatDesc": "打开由 AI4SS 社区维护的专用帖子，查看当前加入方式。",
      "community.wechatButton": "查看微信群",
      "contribute.eyebrow": "论文提交",
      "contribute.title": "推荐一篇论文",
      "contribute.lead": "提交结构化元数据供维护者审核。论文只有通过验证并获维护者批准后，才会加入集合。",
      "contribute.submit": "提交",
      "contribute.submitDesc": "粘贴 Zotero 元数据，或只填写论文基本信息。",
      "contribute.review": "审核",
      "contribute.reviewDesc": "维护者检查研究范围与重复项，并补全分类。",
      ...
      "form.pipelineHint": "可选 · 选择、拖入或粘贴图片 · 4 × 10 MiB",
      ...
      "form.paperFile": "论文原文",
      "form.paperFileHint": "可选 · 选择或拖入 PDF · 50 MiB",
      ...
      "form.supporting": "可选辅助文件",
      "form.supportingHint": "Pipeline 图片或论文 PDF",
      "form.more": "更多可选字段",
      ...
      "zotero.categoryUnrecognized": "未识别分类标签，维护者会在审核时补充分类。",
      ...
      "submission.clearConfirm": "确定清除已填写或导入的元数据及所选文件吗？此操作无法撤销。",
