(() => {
  ...
  const messages = {
    en: {
      ...
      "form.paperFileHint": "recommended; upload the original PDF for AI-assisted summary generation",
    ...
    zh: {
      ...
      "form.categories": "分类 *",
      "form.categoryLead": "请先展开领域，再从分类体系中选择最多四个叶子任务。",
      ...
      "form.paperFile": "论文原文",
      "form.paperFileHint": "推荐填写；上传论文 PDF 以供 AI 辅助生成总结",
