(() => {
  ...
  const messages = {
    en: {
      ...
      "form.pipelineImage": "Pipeline images",
      "form.pipelineHint": "recommended · choose, drop, or paste · 4 × 10 MiB",
      "form.pipelineDropLabel": "Choose, drop, or paste pipeline images",
      "form.chooseImages": "Choose",
      "form.chooseImagesLabel": "Choose pipeline images",
      "form.pasteImages": "Paste",
      "form.pasteImagesLabel": "Paste a pipeline image from the clipboard",
      "form.clearImages": "Clear images",
      "form.paperFile": "Paper file",
      "form.categoryLeadBefore": "Expand a field, then select up to",
      "form.categoryLeadAfter": "leaf tasks.",
      "form.paperFileHint": "recommended · choose or drop PDF · 50 MiB",
      "form.paperFileDropLabel": "Choose or drop a paper PDF",
      "form.choosePaperFile": "Choose PDF",
      "form.choosePaperFileLabel": "Choose a paper PDF",
      ...
      "upload.popupBlockedTitle": "Upload could not start",
      "upload.popupBlocked": "Allow pop-ups for this site, then submit again. The waiting tab must remain open until the upload finishes.",
      "upload.preparingTitle": "Preparing file upload — please wait",
      "upload.preparingDetail": "Preparing {total} selected file(s). Do not close or leave this page; GitHub will open only after every file is uploaded.",
      "upload.waitingTitle": "Files are uploading — please wait",
      "upload.waitingPage": "The upload is in progress. Keep this tab open and wait here. If no file finishes within 45 seconds, return to the survey form to choose whether to continue or use the GitHub Issue form.",
      "upload.progressTitle": "Uploading files — please wait",
      "upload.progress": "File {completed} of {total}: {name}. Do not close or leave this page.",
      "upload.completeTitle": "Upload complete",
      "upload.complete": "All {total} selected file(s) are ready. Opening the GitHub issue now…",
      "upload.recoveryEyebrow": "Upload interrupted",
      "upload.recoveryTitle": "Choose how to continue",
      "upload.recoveryStatus": "{message} {completed} of {total} files are safely uploaded.",
      "upload.recoveryWaitingTitle": "Upload paused — choose on the survey form",
      "upload.recoveryWaiting": "Return to the survey form. You can continue uploading the unfinished files or open the GitHub Issue form and attach them manually.",
      "upload.recoveryProgress": "{completed} of {total} files are already uploaded and will be kept.",
      "upload.recoveryNext": "Next unfinished file: {name}.",
      "upload.recoveryHint": "Completed uploads are kept. Continue retries only the unfinished files; alternatively, open the prefilled GitHub Issue and attach the unfinished files manually.",
      "upload.recoveryRetry": "Continue uploading",
      "upload.recoveryFallback": "Open Issue and upload manually",
      "upload.recoveryConfirm": "{message}\n\n{progress} {pending}\n\nSelect OK to continue uploading only unfinished files, or Cancel to open the GitHub Issue form and attach them manually.",
      "upload.retryingTitle": "Continuing the remaining uploads — please wait",
      "upload.retrying": "{completed} of {total} files are safe. Retrying the remaining {remaining} file(s).",
      "upload.failedFallbackTitle": "Automatic upload failed — manual attachment required",
      "upload.failedFallback": "The file transfer stopped: {message} A prefilled GitHub Issue is opening now. Successful uploads are retained; manually attach only fields marked as required.",
      "upload.timeout": "No file finished uploading within {seconds} seconds.",
      "upload.manualIssueReminder": "Successful uploads were retained. Before submitting the Issue, manually attach only fields marked “Manual attachment required”.",
      "upload.manualFallbackTitle": "Direct upload unavailable",
      "upload.manualFallback": "The upload service is not configured. GitHub will ask you to attach the selected files manually.",
      "clipboard.reading": "Reading the clipboard…",
      "clipboard.unsupported": "This browser does not support clipboard file access; use Choose or drag the file here.",
      "clipboard.permission": "Clipboard access was not allowed. Allow it for this site, then click Paste again.",
      "clipboard.failed": "The clipboard could not be read; use Choose or drag the file here.",
      ...
      "pipeline.clipboardEmpty": "No supported image is currently in the clipboard.",
      ...
      "paperFile.imagesRouted": "{count} image(s) were added to Pipeline images; the paper field accepts PDF only.",
    ...
    zh: {
      ...
      "community.discussionHint": "也可以前往 GitHub Discussions 提问并参与公开的学术讨论。",
      "community.discussionButton": "打开 GitHub 讨论区",
      ...
      "form.pipelineHint": "推荐 · 选择、拖入或粘贴图片 · 4 × 10 MiB",
      "form.pipelineDropLabel": "选择、拖入或粘贴 Pipeline 图片",
      "form.chooseImages": "选择图片",
      "form.chooseImagesLabel": "选择 Pipeline 图片",
      "form.pasteImages": "粘贴",
      "form.pasteImagesLabel": "从剪贴板粘贴 Pipeline 图片",
      "form.clearImages": "清除图片",
      "form.pipelineHelp": "最多选择四张图片，每张不超过 10 MiB。打开 GitHub Issue 前可先预览。",
      "form.paperFile": "论文原文",
      "form.paperFileHint": "推荐 · 选择或拖入 PDF · 50 MiB",
      "form.paperFileDropLabel": "选择或拖入论文 PDF",
      "form.choosePaperFile": "选择 PDF",
      "form.choosePaperFileLabel": "选择论文 PDF",
      ...
      "upload.popupBlockedTitle": "无法开始上传",
      "upload.popupBlocked": "请允许本网站打开弹窗后重新提交。上传完成前必须保持等待页面开启。",
      "upload.preparingTitle": "正在准备文件上传，请稍候",
      "upload.preparingDetail": "正在准备 {total} 个文件。请勿关闭或离开本页；全部上传成功后才会打开 GitHub。",
      "upload.waitingTitle": "文件正在上传，请耐心等待",
      "upload.waitingPage": "上传正在进行，请保持本页面开启并在此等待。若连续 45 秒没有文件完成，请返回 Survey 表单选择继续上传或转到 GitHub Issue 表单。",
      "upload.progressTitle": "文件正在上传，请勿离开",
      "upload.progress": "正在上传第 {completed} / {total} 个文件：{name}。请勿关闭或离开本页。",
      "upload.completeTitle": "文件上传完成",
      "upload.complete": "全部 {total} 个文件已就绪，正在打开 GitHub Issue…",
      "upload.recoveryEyebrow": "上传已中断",
      "upload.recoveryTitle": "请选择如何继续",
      "upload.recoveryStatus": "{message} 已安全上传 {completed} / {total} 个文件。",
      "upload.recoveryWaitingTitle": "上传已暂停，请返回表单选择",
      "upload.recoveryWaiting": "请返回 Survey 表单。你可以继续上传未完成文件，也可以打开 GitHub Issue 表单并手动添加这些文件。",
      "upload.recoveryProgress": "已上传的 {completed} / {total} 个文件会被保留。",
      "upload.recoveryNext": "下一个未完成文件：{name}。",
      "upload.recoveryHint": "已经完成的文件不会重复上传。选择继续时只重试未完成文件；也可打开预填的 GitHub Issue，在表单中手动添加未完成文件。",
      "upload.recoveryRetry": "继续上传",
      "upload.recoveryFallback": "打开 Issue 并手动上传",
      "upload.recoveryConfirm": "{message}\n\n{progress} {pending}\n\n选择“确定”只继续上传未完成文件；选择“取消”则打开 GitHub Issue 表单并手动添加。",
      "upload.retryingTitle": "正在继续上传剩余文件，请稍候",
      "upload.retrying": "已安全上传 {completed} / {total} 个文件，正在重试剩余 {remaining} 个。",
      "upload.failedFallbackTitle": "自动上传失败，请手动添加附件",
      "upload.failedFallback": "文件传输已停止：{message} 正在打开预填好的 GitHub Issue。成功上传的文件会保留；请只手动添加标记为需要补充的字段。",
      "upload.timeout": "连续 {seconds} 秒没有任何文件完成上传。",
      "upload.manualIssueReminder": "成功上传的文件会被保留。提交 Issue 前，请只手动添加标有“Manual attachment required”的字段。",
      "upload.manualFallbackTitle": "直接上传暂不可用",
      "upload.manualFallback": "上传服务尚未配置；进入 GitHub 后仍需手动添加所选文件。",
      "clipboard.reading": "正在读取剪贴板…",
      "clipboard.unsupported": "当前浏览器不支持读取剪贴板文件，请选择或拖入文件。",
      "clipboard.permission": "未获得剪贴板读取权限。请允许本网站访问后再次点击粘贴。",
      "clipboard.failed": "无法读取剪贴板，请选择或拖入文件。",
      ...
      "pipeline.clipboardEmpty": "剪贴板中没有可用的图片。",
      ...
      "paperFile.imagesRouted": "已将 {count} 张图片加入 Pipeline 图片；论文原文字段仅接受 PDF。",
